...
export default function () {
  // http.get('http://127.0.0.1:8001/api/v1/namespaces/jenkins-test-1-namespace/services/jenkins-test-1-service/proxy/get-all-transaction');
  let response = http.get("http://192.168.68.2:30918/get");
